...
const DocuRAG = () => {
  ...
  const prompts = [
    { title: 'Explain a concept', desc: "like I'm five" },
    { title: 'Draft an email', desc: 'to reschedule a meeting' },
    { title: 'Brainstorm ideas', desc: 'for a weekend project' },
    { title: 'Write code', desc: 'to reverse a string in Python' }
  ];
          ...
          <div className="prompt-grid">
            {prompts.map((prompt, i) => (
              <div key={i} className="prompt-card">
                ...
                <div className="card-desc">{prompt.desc}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="input-area">
          ...
          <div className="input-wrapper">
            <input
              ...
              accept={uploadType === 'image' ? "image/*" : ".pdf,.doc,.docx,.txt,.png,.jpg,.jpeg,.gif"}
            />
            ...
            />
            <button className={`send-btn ${(inputValue || selectedFile) ? 'active' : ''}`}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
